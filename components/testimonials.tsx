...
const testimonials = [
  {
    quote:
      "Après mon mariage, j'ai traversé une période très difficile à cause de problèmes de conception. Je me sentais perdue et épuisée de faire semblant que tout allait bien. 😔Un jour, j'ai découvert le témoignage de Deborah Manariyo, une femme très courageuse et pleine d'amour. Son histoire m'a fait réaliser que je n'étais pas seule. J'ai vu son émission sur la chaîne Siren Vibes, l'ai contactée, et elle m'a aidée avec un cœur rempli d'amour. ❤
